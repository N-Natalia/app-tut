...
export class EstadoReservasVoluntariasComponent implements OnInit {
  ...
  buttomDesabilitado(dia:string,hora:Date,posicion:number){
    ...
    this.fechas[posicion] <= this.fechaEnTiempoReal && this.posicionFechaMostrar==0;
                            ...
                            accept: () => {
                              ...
                              this.sesionTutoriaService.confirmarByIdReserva(reserva.idReserva!)
                                  .then(()=>{
                                    ...
                                    this.messageService.add({ severity: 'success', summary: 'Success', detail: 'La confirmación de esta reserva fue realizado con exito!' });
                              ...
                              switch (type) {
                                case ConfirmEventType.REJECT:
                                  ...
                                  .then(()=>{
                                    ...
                                    this.messageService.add({ severity: 'success', summary: 'Success', detail: 'La confirmación de esta reserva fue cancelado con éxito!' });
                                  })
                                  .catch((error) => {
