                ...
                .then(tutor=>{
                  ...
                  this.confirmationService.confirm({
                    ...
                    accept: () => { 
                      ...
                      .then( reservaActivo =>{
                        this.messageService.add({ severity: 'info', summary: 'Info', detail: 'Usted tiene una reserva activa, para cambiar la fecha de su reserva  puede cancelar su reserva.' });
